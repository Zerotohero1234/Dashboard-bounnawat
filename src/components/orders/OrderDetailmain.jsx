...
import { deliverOrder, getOrderDetails, notpaidOrder } from "../../Redux/Actions/OrderActions";
                ...
                <div className="box shadow-sm bg-light">
                  {
                    order.isDelivered ? (
                      <button className="btn btn-success col-12">
                        ຈັດສົ່ງແລ້ວເມື່ອວັນທີ ({" "} {moment(order.isDeliveredAt).format("MMM Do YY")} )
                      </button>
                    ) :
                    (
                      <>
                ...
                </div>
                {
                    !order.isDelivered &&
                      <div className="box shadow-sm bg-light">
                        ...
                        <button onClick={notpaidHandler} className="btn btn-danger col-12">
